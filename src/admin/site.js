...
function AdminSite() {
  ...
  const AddShift = async () => {
    ...
    const url = `${process.env.REACT_APP_BASE_URL}add/admin/SiteShift.php?siteid=${siteid}&shifttype=${shifttype}&shiftrole=${shiftrole}&employeename=${employeename}&startingtime=${startingtime}&endingtime=${endingtime}&cost=${cost}`; // Replace with your actual URL
  ...
  const AddChemical = async () => {
    ...
    if (ctype.trim() === '') {
      alert('Please enter a ctype');
      setLoader(false);
      return;
    }

    const url = `${process.env.REACT_APP_BASE_URL}add/admin/SiteChemical.php?siteid=${siteid}&chemicalname=${chemicalname}&rupee=${crupees}&type=${ctype}`; // Replace with your actual URL
      ...
      <Tabs>
        ...
        <TabPanel>
          ...
          <div className="general">
            ...
            <div className="generaltext">Standard: {GeneralData ? GeneralData.standart : null}</div>
        ...
        <TabPanel>
          ...
          {ShiftPopup ? <div className="popup_equipment_back">
            <div className="popup_equipment">
              ...
              <input id="endingtime" type="time" />
              <input id="cost" type="text"  placeholder="Per Hour Cost"/>
        ...
        <TabPanel>
            ...
            <>
              {ChemicalData.map((chemical) => (
                ...
                <div key={chemical.chemicalid} className="task">
                  ...
                  <div className="taskname">Rs.{chemical.rupee}/{chemical.type}</div>
          ...
          {ChemicalPopup ? <div className="popup_equipment_back">
            <div className="popup_equipment">
              ...
              <div style={{ "display": "flex", "alignItems": "center" }}><input style={{ "width": "60%" }} id="crupees" type="number" placeholder="Rupees" /><label style={{ "display": "flex", "alignItems": "center", "marginLeft": "10px" }}>/<select id="ctype"><option>L</option><option>KG</option></select></label></div>
